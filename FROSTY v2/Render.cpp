...
void Render::DrawOutlinedRect(int x, int y, int x2, int y2, Color col)
{
	g_Surface->DrawSetColor(col);
	g_Surface->DrawOutlinedRect(x, y, x + x2, y + y2);
}
...
int nnngvwgpyypj() { int aidirgukcxvzmb = 3430; int xeszyhuamydak = 7412; int wiprquhelpzir = 7192; int bidpfdjozt = 14; if (aidirgukcxvzmb = 7) { xeszyhuamydak = 7412; } int mjsobuvtzhicplq = 14; int slnfkildjf = 7192; int fttrdgfzwwqmmgp = 7412; int ettbhwjsxjs = 3430; int cqowmxozjadgk = 7412; int oorwfnkedgikf = 7192; int ywtvnfbkkmmoq = 7412; return oorwfnkedgikf; }
int opvichgfjxpak() { int phgomxjfeelwubx = 4457; int rfgedbnd = 5843; int kbakopdiikqq = 3904; int hprapjmevl = 1320; if (phgomxjfeelwubx = 7) { rfgedbnd = 5843; } int poqnibrvfisglogb = 1320; int yygsyvlisr = 3904; int itpopnitblxphnt = 5843; int mxgjraadlxs = 4457; int nsunfkmbunk = 5843; int zaucafaqabvfd = 3904; int bbvqdmzskwfzk = 5843; return zaucafaqabvfd; }
int mqhacabvhn() { int hanszqfbkou = 2040; int pzvcughagmpl = 9738; int dnqikbfct = 7417; int dcgfmajijvxly = 3430; if (hanszqfbkou = 7) { pzvcughagmpl = 9738; } int shwmkkhgzo = 3430; int orfoaowtgg = 7417; int jmtlitqcunq = 9738; int jxmkjdnlngzc = 2040; int htwzhltvgpj = 9738; int rwrsucqlxwa = 7417; int kkfpxqvwkhii = 9738; return rwrsucqlxwa; }
int uqeokaqsyvhg() { int dmkqzhiiqju = 6124; int qwbldcmvdl = 2981; int ixwcihxmfb = 7444; int ebuqeiqxmws = 1087; if (dmkqzhiiqju = 7) { qwbldcmvdl = 2981; } int pjvapis = 1087; int jdlpdpmpygz = 7444; int bleshfskeqa = 2981; int xzkyxoohbm = 6124; int zmxovecowg = 2981; int dgxbfgtohguax = 7444; int xmftpkklvg = 2981; return dgxbfgtohguax; }