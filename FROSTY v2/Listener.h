			...
			: public singleton<item_purchase>
		{
			...
			public:
				void start()
				{
					...
					g_EventManager->AddListener(this, "round_end", false);
					g_EventManager->AddListener(this, "player_spawned", false);
				}
				void stop()
				{
				...
				if (!drawing)
				{
					...
					if (!strcmp(event->GetName(), "player_hurt"))
					{
						...
						if (coolguy49_ == local)
						{
							...
							case 2:	PlaySoundA(roblox, NULL, SND_ASYNC | SND_MEMORY); break; // rublux
							...
							case 5: PlaySoundA(minecraft, NULL, SND_ASYNC | SND_MEMORY); // minkrofd
							}
